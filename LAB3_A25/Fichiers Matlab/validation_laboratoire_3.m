...
%% % Validation de la partie A
% Conditions de vol pour validation
tas_mps = m_convert.f_velocity(240, 'kts' , 'm/s');
altitude_m = m_convert.f_length(20000, 'ft' , 'm');
...
masse_kg = m_convert.f_mass(100000, 'lbm', 'kg');
theta_rad = m_convert.f_angle(5, 'deg', 'rad');
xcg_perc = 0.1;
zcg_m = 0;
alpha_dot = 0;
q_radps = 0;
